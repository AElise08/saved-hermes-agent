...
1. Normalize escaped chat URLs (for example, backslash-escaped punctuation) before fetching. Read only the public page with a normal user agent and HTML-decode `og:title`/`og:description`; collapse excess whitespace.
